...
if (isset($_POST['submit'])) {
    ...
    if ($update) {
        header("Location: data-jurusan.php?msg=update-success");
        exit;
    } else {
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="nama_jurusan" class="form-control" id="nama_jurusan" value="<?= htmlspecialchars($data['nama_jurusan']) ?>" required>
                  </div>
                </div>
                <div class="card-footer">
                  <button type="submit" name="submit" class="btn btn-primary"><i class="fas fa-save"></i> Simpan Perubahan</button>
                  <a href="data-jurusan.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Batal</a>
                </div>
              </form>
            </div>
          </div>
